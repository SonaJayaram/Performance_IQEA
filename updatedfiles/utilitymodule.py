...
def update_jmx_file(jmx_content, config):
    ...
    maps global loop properties, and injects strict hard timeouts to prevent overruns.
    """
    print("#### config", config)
    ...
    for elem in root.iter():
        ...
        # Error handling mode
            ...
            elem.text = "stopthread"

    # ==============================================================================
    # 🛡️ SYSTEM TIMEOUT INJECTION PATTERNS FOR ALL SAMPLERS & DEFAULTS
    # ==============================================================================
    # Iterates elements explicitly to fix missing tags and force-kill hanging requests
